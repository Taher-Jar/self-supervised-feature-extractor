...
def main(path_dir_images, path_backbone):
    ...
    image_paths = list(path_dir_images.glob("**/*.jpg"))
...
if __name__ == "__main__":
    ...
    args = parser.parse_args('/home/tjarjanazi/self-supervised-dev/dataset/neocr_dataset/Images/users/pixtract/dataset', '/home/tjarjanazi/self-supervised-dev/model_dir/backbone/model.pth')
    main(**vars(args))\
